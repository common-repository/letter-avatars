...
Tags: letter, letter-avatar, avatar, custom-avatar, gravatar, wp-user-avatar
...
* Improvement: Improved handling for gravatar checks
* Improvement: Increased plugin performance
* Improvement: Improved username handling - Letters will be based on name, then on e-mail
* Improvement: Better inline CSS generation
* Bugfix: Fixed CSS validation errors
* Bugfix: Fixed various notices and warnings
* Bugfix: Fixed Letter Avatars not working for comments fetched via ajax
